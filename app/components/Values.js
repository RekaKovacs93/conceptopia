...
export default function Values() {
    ...
    return (
      <div className="h-screen w-screen flex flex-col items-center justify-center">
        ...
        <div className="flex items-center justify-center gap-96 mx-40">
          ...
          <div className=" text-center relative bg-red w-full flex flex-col justify-center items-center">
                <svg width="600" height="100" xmlns="http://www.w3.org/2000/svg" className="pos">
                    <defs>
